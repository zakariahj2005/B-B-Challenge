                        ...
                        <img class="card-img-top" src= <?php echo 'images/'.$cottage['cottage_img']; ?> alt="cottage_name" > <!-- maak image en naam dynamisch -->
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">&euro; <?= $cottage['cottage_price_a']; ?></</li><!-- maak prijs volwassenen dynamisch -->
                                    <li class="list-group-item">&euro;<?= $cottage['cottage_price_c']; ?></li><!-- maak prijs kinderen dynamisch -->
                                </ul>
