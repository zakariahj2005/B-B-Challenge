<?php
    ...
    $sql = "SELECT facilities.facility_name FROM `cottages_facilities` INNER JOIN facilities ON facilities.facility_id=cottages_facilities.facility_id WHERE cottages_facilities.cottage_id = " . $huisjeID; //$cottageID is de variabele met de ID van de huisjes, check: heb ik hem zo genoemd?
